            ...
            ?>
                <tr>
                    ...
                    <td class="p-1">
                        <?php if ($akses == 1) { ?>
                            <?php if ($sts_info == '1') { ?>
                                ...
                                <?php if ($sts_info == '2') { ?>
                                <?php } elseif ($sts_info == '1') { ?>
                                    <a class="pointer" onclick="toggle('<?= $value['id_mohoninfo'] ?>')" class="btn btn-circle btn-sm <?= $sts_info ? 'btn-light' : 'btn-light' ?>" title="<?= $sts_info ? 'Tampilkan Pesan ini' : '' ?>"><i class="fas fa-eye text-primary"></i>
                                    </a>
                                <?php } ?>

                                <?= esc($nama) ?>

                            <?php } elseif ($sts_info == '0') { ?>

                                <a><i class="mdi mdi-message-settings-variant text-warning font-18 p-0" title="<?= $info_ygdibutuhkan ?>"></i></a>
                                <b><?= esc($nama) ?></b>

                            <?php } else { ?>

                                <a class="pointer" onclick="toggle('<?= $value['id_mohoninfo'] ?>')" class="btn btn-circle btn-sm <?= $sts_info ? 'btn-danger' : 'btn-light' ?>" title="<?= $sts_info ? 'Jangan Tampilkan' : 'Aktifkan' ?>"><i class="fas fa-eye-slash text-danger"></i>
                                </a>
                                <?= esc($nama) ?>
                            <?php } ?>
                        ...
                        <?php } else { ?>
                            <?php if ($sts_info == '1') { ?>
                                ...
                                <?php if ($sts_info == '2') { ?>
                                <?php } elseif ($sts_info == '1') { ?>
                                    <a class="pointer" class="btn btn-circle btn-sm <?= $sts_info ? 'btn-light' : 'btn-light' ?>" title="<?= $sts_info ? 'Tidak Tampil di Suara Anda' : 'Sembunyikan' ?>"><i class="fas fa-eye text-info"></i>
                                    </a>
                                <?php } ?>
                                <?= esc($nama) ?>
                            ...
                            <?php } else { ?>
                                ...
                                <a class="pointer" class="btn btn-circle btn-sm <?= $sts_info ? 'btn-danger' : 'btn-light' ?>" title="<?= $sts_info ? 'Telah Tampil di Suara Anda' : 'Aktifkan' ?>"><i class="fas fa-eye-slash text-secondary"></i>
                                </a>
                                <?= esc($nama) ?>
                            <?php } ?>
                    ...
                    <td class="text-center p-0">
                        ...
                        <?php if ($akses == 1) { ?>
                            <?php if ($sts_info == '1') { ?>
                                <button type="button" onclick="toggle('<?= $value['id_mohoninfo'] ?>')" class="btn btn-circle btn-sm p-1 btn-light" title="Telah ditanggapi"><i class="fas fa-check-circle text-info font-14"></i>
                                </button>
                            <?php } else if ($sts_info == '2') { ?>
                                <button type="button" onclick="toggle('<?= $value['id_mohoninfo'] ?>')" class="btn btn-circle btn-sm p-1 btn-light" title="Telah ditanggapi dan ditampilkan"><i class="far fa-check-circle font-14 text-success"></i>
                                </button>
                            <?php } else { ?>
